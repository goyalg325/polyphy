          ...
          {users.map(user => (
            ...
            >
              ...
              <button
                ...
                className=" lg:mx-2 mt-4 lg:mt-0 focus:outline-none bg-black hover:bg-gray-800 focus:ring-1 focus:ring-rose-300 w-full px-3 lg:w-38 text-sm h-10 rounded-md"
              >
